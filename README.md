...
Porta 1 → Laboratório de Informática
Porta 2 → Sala dos Professores
Porta 3 → Almoxarifado de Equipamentos
...
Além de simular o controle de três portas diferentes, o projeto ajudou a desenvolver habilidades importantes em montagem de circuitos, organização do código e integração entre hardware e software. A utilização do servo motor para representar a trava das portas tornou o sistema mais dinâmico e próximo de uma aplicação real.

De forma geral, a atividade foi muito importante para ampliar os conhecimentos em sistemas embarcados e automação, mostrando como diferentes componentes podem trabalhar juntos para criar soluções inteligentes e funcionais.
